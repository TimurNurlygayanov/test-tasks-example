...
@patch('builtins.open', new_callable=mock_open, read_data='1    test    me first')
...
@patch('builtins.open', new_callable=mock_open, read_data='1    test  test  me first')
...
@patch('builtins.open', new_callable=mock_open, read_data=LONG_STRING)
...
@patch('builtins.open', new_callable=mock_open, read_data=LONG_STRING_REPEATS)
...
@patch('argparse.ArgumentParser.parse_args',
       return_value=argparse.Namespace(parser='build', dataset_path='data.txt',
